...
vm_size = config.get("vmSize", "Standard_B1ls")
...
resource_group = resources.ResourceGroup("group")
...
init_script = f"""#!/bin/bash
    ...
    <body>
        <h1>Hello, Mahasiswa Amikom!!! 👋</h1>
        <p>Selamat <a href="https://auth.amikom.ac.id/mhs#!/">UAS</a>.</p>
    </body>
    </html>' > index.html
